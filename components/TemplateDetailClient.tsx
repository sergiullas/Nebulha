...
export function TemplateDetailClient({ template }: TemplateDetailClientProps) {
  ...
  return (
    <div className="detail-page">
          ...
          {doneOutcome === 'success' ? (
            <div className="provision-outcome provision-outcome-success template-done-card">
              ...
              <p className="provision-outcome-body">
                {template.name} has been provisioned successfully. All resources listed in the execution preview are
                being created.
              </p>
            ...
            <div className="provision-outcome provision-outcome-pending template-done-card">
              ...
              <p className="provision-outcome-body">
                {template.name} requires platform team approval before provisioning can proceed. You will be notified
                when the request is reviewed.
              </p>
              <div className="template-done-resources">
                {template.requiresApprovalElements.map((el) => (
                  <p key={el} className="template-done-resource-item">
                    Pending approval: {el}
                  </p>
                ))}
              </div>
      ...
      {/* ── MAIN LAYOUT (overview / configure / review) ── */}
      {step !== 'done' && (
          ...
          <div className="detail-main">
            ...
            {step === 'configure' && (
              <>
                ...
                <div className="template-step-actions">
                  <button type="button" className="incident-button secondary" onClick={() => setStep('overview')}>
                    ← Back
                  </button>
                  <button type="button" className="provision-cta-button template-step-cta" onClick={() => setStep('review')}>
                    Review →
                  </button>
                </div>
              </>
            ...
            {step === 'review' && (
              <>
                ...
                <div className="template-step-actions">
                  <button type="button" className="incident-button secondary" onClick={() => setStep('configure')}>
                    ← Back
                  </button>
                  <button type="button" className="provision-cta-button template-step-cta" onClick={handleProvision}>
